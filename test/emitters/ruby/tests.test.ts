...
describe('generateTests', () => {
  ...
  it('generates CRUD tests with WebMock stubs', () => {
    ...
    expect(testFile.content).toContain('stub_request(:get, "https://api.example.com/organizations")');
    expect(testFile.content).toContain('stub_request(:get, "https://api.example.com/organizations/test_id")');
    expect(testFile.content).toContain('stub_request(:post, "https://api.example.com/organizations")');
  });
